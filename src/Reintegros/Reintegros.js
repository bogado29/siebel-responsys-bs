function Reintegros(Inputs, Outputs) {
    try {
      ...
      var sVoucherCoberturaDeCaso:chars = Inputs.GetProperty("VoucherCoberturaDeCaso");
      ...
      var sOrganizacionEmisoraDelCaso:chars = Inputs.GetProperty("OrganizacionEmisoraDelCaso");
      var sEmailReintegro:chars = Inputs.GetProperty("EmailReintegro");
      var sNPrestacionPrincipal:chars = Inputs.GetProperty("NPrestacionPrincipal");
